...
import SpringBoot from "../../assets/images/skills/Spring_Boot.svg";
      ...
      <motion.div style={{ scale }} className="container">
        <Terminal>
          ...
          <TechGrid>
            ...
            <div className="tech-grid__item">
              <img src={SpringBoot} alt="Spring Boot Icon" title="Spring Boot" />
              <p>Spring Boot</p>
            </div>
            <div className="tech-grid__item">
            ...
            <div className="tech-grid__item">
              <img src={kafka} alt="kafka" title="kafka" />
              <p>kafka</p>
            </div>
